...
class BigDecrement : public BigDecrement<WA,WB-D,D>
{
  public:
	...
	for ( size_t count = 0; count < 1000; ++count ) {
		...
		cout << "ERROR: difference != a in " << __FILE__ << " at line " << __LINE__ << endl;
		cout << "  a        " << v_sc_bigint_a << " width " << WA << endl;
		cout << "  b        " << v_sc_bigint_b << " width " << WB << endl;
		...
		cout << "ERROR: difference != b in " << __FILE__ << " at line " << __LINE__ << endl;
		cout << "  a        " << v_sc_bigint_a << " width " << WA << endl;
		cout << "  b        " << v_sc_bigint_b << " width " << WB << endl;
		cout << " product " << v_sum << endl;
		cout << " difference " << v_difference << endl;
	...
	for ( size_t count = 0; count < 1000; ++count ) {
		...
		cout << "ERROR: difference != a in " << __FILE__ << " at line " << __LINE__ << endl;
		cout << "  a        " << v_sc_bigint_a << " width " << WA << endl;
		cout << "  b        " << v_sc_biguint_b << " width " << WB << endl;
		cout << " product " << v_sum << endl;
		cout << " difference " << v_difference << endl;
		assert( v_difference == v_sc_bigint_a );
	    }
	...
	for ( size_t count = 0; count < 1000; ++count ) {
		...
		cout << "ERROR: difference != a in " << __FILE__ << " at line " << __LINE__ << endl;
		cout << "  a        " << v_sc_biguint_a << " width " << WA << endl;
		cout << "  b        " << v_sc_biguint_b << " width " << WB << endl;
		cout << " sum        " << v_sum << endl;
		cout << " difference " << v_difference << endl;
	...
	for ( size_t count = 0; count < 1000; ++count ) {
		...
		cout << "ERROR: quotient != a in " << __FILE__ << " at line " << __LINE__ << endl;
		cout << "  a        " << v_sc_bigint_a << " width " << WA << endl;
		cout << "  b        " << v_sc_bigint_b << " width " << WB << endl;
		...
		cout << "ERROR: quotient != b in " << __FILE__ << " at line " << __LINE__ << endl;
		cout << "  a        " << v_sc_bigint_a << " width " << WA << endl;
		cout << "  b        " << v_sc_bigint_b << " width " << WB << endl;
		cout << " product  " << v_product << endl;
		cout << " quotient " << v_quotient << endl;
